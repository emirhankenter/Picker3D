...
{
    [Serializable] public class LanguageFlagDictionary : SerializableDictionary<Language, Sprite> { }
    public class LanguageSelectionButton : MonoBehaviour
    {
        public event Action<Language> Clicked;
        ...
        public void Check()
        {
            _checkMark.enabled = (Language)PlayerData.Instance.Language == _language;
        }
